...
public class ValidadorImportacao {
  ...
  /**
   * Retorna o valor como {@link String} do primeiro atributo cuja chave contém
   * o trecho informado.
   *
   * @param trecho trecho da chave a ser procurado
   * @return valor convertido para {@link String} ou {@code null} se não for
   *         possível converter
   */
  public String getStringAtributoContendo(String trecho) {
    Object valor = getAtributoContendo(trecho);
  ...
  /**
   * Retorna o valor como {@link Boolean} do primeiro atributo cuja chave contém
   * o trecho informado.
   *
   * @param trecho trecho da chave a ser procurado
   * @return valor convertido para {@link Boolean} ou {@code null} se não for
   *         possível converter
   */
  public Boolean getBooleanAtributoContendo(String trecho) {
    Object valor = getAtributoContendo(trecho);
