...
/**
 * Represents a project entity with management and financial information.
 * Can be mapped from spreadsheet data (e.g., projects.xlsx).
 */
public class Project {
     ...
     */
    public Project(Long id, String name, String description, String projectManager, 
                   String status, String priority, LocalDate startDate, LocalDate expectedEndDate, 
                   LocalDate actualEndDate, BigDecimal allocatedBudget, BigDecimal actualSpent, 
                   String client, String category, Integer completionPercentage, String riskLevel) {
        this.id = id;
        this.name = name;
